...
// [SECTION] User.h Guide / ShowUserGuide()
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Text Input"))
    {
        ...
        IMGUI_DEMO_MARKER("Widgets/Text Input/Completion, History, EditDarkMode Callbacks");
        if (ImGui::TreeNode("Completion, History, EditDarkMode Callbacks"))
        {
            struct Funcs
            {
            ...
            ImGui::InputText("EditDarkMode", buf3, 64, ImGuiInputTextFlags_CallbackEdit, Funcs::MyCallback, (void*)&edit_count);
            ImGui::SameLine(); HelpMarker(
...
static void ShowDemoWindowPopups()
{
    ...
    //   we are used to with regular Begin() calls. User.h can manipulate the visibility state by calling OpenPopup().
    ...
    if (ImGui::TreeNode("Popups"))
    {
        ...
        if (ImGui::BeginPopup("my_file_popup", ImGuiWindowFlags_MenuBar))
        {
            if (ImGui::BeginMenuBar())
            {
                ...
                if (ImGui::BeginMenu("EditDarkMode"))
                {
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (ImGui::TreeNode("Inputs"))
        {
            ...
            // User.h code should never have to go through such hoops!
